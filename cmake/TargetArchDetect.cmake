...
function(target_architecture output_var)
    if(APPLE AND CMAKE_OSX_ARCHITECTURES)
        ...
        # Note that it's not possible to compile PowerPC applications if you are using the OS X SDK version 10.6 or
        # later - you'll need 10.4/10.5 for that, so we disable it by default See this page for more information:
        # http://stackoverflow.com/questions/5333490/how-can-we-restore-ppc-ppc64-as-well-as-full-10-4-10-5-sdk-support-
        # to-xcode-4
        ...
        # architecture. The program will always fail to compile (both because file is not a valid C program, and
        # obviously because of the presence of the #error preprocessor directives... but by exploiting the preprocessor
        # in this way, we can detect the correct target architecture even when cross-compiling, since the program itself
