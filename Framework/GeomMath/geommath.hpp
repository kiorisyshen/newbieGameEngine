...
struct Vector2Type
{
    union {
        ...
        swizzle<newbieGE::Vector2Type, T, 0, 1> xy;
        swizzle<newbieGE::Vector2Type, T, 1, 0> yx;
    };
...
struct Vector3Type
{
    union {
        ...
        swizzle<newbieGE::Vector2Type, T, 0, 1> xy;
        swizzle<newbieGE::Vector2Type, T, 1, 0> yx;
        swizzle<newbieGE::Vector2Type, T, 0, 2> xz;
        swizzle<newbieGE::Vector2Type, T, 2, 0> zx;
        swizzle<newbieGE::Vector2Type, T, 1, 2> yz;
        swizzle<newbieGE::Vector2Type, T, 2, 1> zy;
        swizzle<newbieGE::Vector3Type, T, 0, 1, 2> xyz;
        swizzle<newbieGE::Vector3Type, T, 1, 0, 2> yxz;
        swizzle<newbieGE::Vector3Type, T, 0, 2, 1> xzy;
        swizzle<newbieGE::Vector3Type, T, 2, 0, 1> zxy;
        swizzle<newbieGE::Vector3Type, T, 1, 2, 0> yzx;
        swizzle<newbieGE::Vector3Type, T, 2, 1, 0> zyx;
        swizzle<newbieGE::Vector3Type, T, 0, 1, 2> rgb;
    };
...
struct Vector4Type
{
    union {
        ...
        swizzle<newbieGE::Vector3Type, T, 2, 1, 0> zyx;
        swizzle<newbieGE::Vector3Type, T, 0, 1, 2> rgb;
        swizzle<newbieGE::Vector4Type, T, 0, 1, 2, 3> rgba;
        swizzle<newbieGE::Vector4Type, T, 2, 1, 0, 3> bgra;
    };
